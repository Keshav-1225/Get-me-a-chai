          ...
          <div className='w-[50vw] flex justify-center items-center'>
            <div className='w-[40vw] h-[80vh] rounded-2xl bg-white px-10 text-slate-950 shadow-2xl pt-[10vh]'>
              ...
              <div className='flex flex-col gap-4 pt-10'>
                ...
                <button onClick={()=>{signIn("google")}} className='flex h-11 items-center justify-center gap-3 rounded-lg border border-slate-300 bg-white px-4 py-2 font-medium text-slate-800 shadow-sm transition-colors hover:bg-slate-50'>
                ...
                <button onClick={() => { signIn("github") }} className='flex h-11 items-center justify-center gap-3 rounded-lg bg-slate-950 px-4 py-2 font-medium text-white shadow-sm transition-colors hover:bg-slate-800'>
